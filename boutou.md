...
<pre>
	...
	特技　精密画, 高速ハンドコンパイル, 弾幕STG(C*VEのSTGをノーミスノーボムで全クリできるレベル),
	　　　DTM(ヤスタカやTimfollinみたいに耳が気持ちいい曲を作る), フードファイティング, 重量上げ300kg
	三つ編みを後ろに結んだ黒髪で前髪ぱっつんスーパーロングヘアーで
	名門私立小学４年の女の子で、国立先端技術大学に一般入試で最年少合格し、
	来年大学生になる超天才少女ハッカー。
	理想の幸せな人生を歩んでもらいたいという親の強い思いで、理幸と名づけられる。
	亡き父の残した半導体の開発・販売を行う大手企業の経営を継ぎ、
	他にも３社経営し、それも大成功を収める。
	他人が書いたソースコード１０万行を一度見ただけで記憶し、
	頭の中で整理し、高速でハンドアセンブルできる特技を持ち、
	ハードウェアの限界を越えるような圧倒的な処理速度を実現。
	かわいすぎてとろけてしまいそうな声を持つ。
	彼女のスペックの高さに、世界中のハッカー達は彼女にメロメロ。
	そんな天才的な彼女だが、たまに不思議ちゃんな一面もみせる寂しがり屋さん。
	触り心地のいい白くてふわふわした動物が好きで白いポメラニアン飼ってる。
	一人でヤ○タカやti○follinよりも緻密で耳が気持ちいい曲を作る
	大食いでハンバーグ8枚食べられるし、レトロゲーも好きで特に
	弾幕シューティングゲームでノーミスノーボムで2周目のボスやっつけて全クリする。
...
<pre>
	...
	理幸の父が作った半導体メーカー主催のプログラミングコンテストで見事優勝し、
	...
	カプセルを全部取り外され、大きな工場のような場所で、修繕されリノベーションされた
	銀座の中銀カプセルタワービルで一人暮らししている。
	好きな歴史上の人物は、ウォーレン・バフェット氏で
	チェリーコークと肉とパテだけのハンバーガーを食べるのにハマっている。
</pre>
弾（Dan）１１歳
<pre>
