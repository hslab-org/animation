...
<pre>
	...
	財布に入るクレジットカードサイズのシングルボードクアンタムコンピューター100枚を手に入れた。
	これ1枚でスパコン京の一京倍のマシンパワー!
	それを使って独自の高速アルゴリズムで暗号通貨を大量に採掘し莫大な富を得る。
	リノベーションされた銀座の中銀カプセルタワービルで一人暮らししている。
</pre>
弾（Dan）１１歳
<pre>
